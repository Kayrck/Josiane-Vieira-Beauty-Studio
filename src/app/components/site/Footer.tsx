      ...
      <div className="mx-auto max-w-7xl px-5 py-16 md:px-10">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-5">
            ...
            <p className="tracking-luxe mt-1 text-[9px] uppercase text-gold">
              Beauty Studio
            </p>
          ...
          <div className="md:col-span-3">
            <p className="tracking-luxe text-[10px] uppercase text-muted-foreground">
              Navegação
            </p>
            <ul className="mt-5 grid grid-cols-2 gap-y-3">
              {NAV_LINKS.map((l) => (
                <li key={l.href}>
                  <a
                    href={l.href}
                    className="text-espresso/70 transition-colors hover:text-gold"
                  >
                    {l.label}
                  </a>
                </li>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 text-sm text-muted-foreground md:flex-row">
          <p>
            © {new Date().getFullYear()} {BRAND.full}. Todos os direitos
            reservados.
          </p>
