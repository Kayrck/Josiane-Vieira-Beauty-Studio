    ...
    >
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-5 md:px-10 lg:min-h-[calc(100svh-8rem)] lg:grid-cols-12">
        ...
        <motion.div style={{ y: yText, opacity: fade }} className="lg:col-span-6">
          ...
          >
            <BookButton message="Olá! Quero agendar meu horário.">
              Agendar agora
            </BookButton>
            <a
              href="#procedimentos"
          ...
          >
            ...
            <p className="text-sm text-espresso/60">
              <span className="text-espresso">+1000 atendimentos</span> ·
              clientes apaixonadas
            </p>
          </motion.div>
        </motion.div>
        ...
        <div className="relative lg:col-span-6">
          ...
          >
            <ImageWithFallback
              ...
              alt="Profissional especialista em design do olhar"
          ...
          >
            <div className="flex items-center gap-2 text-gold">
              ...
              <span className="tracking-luxe text-[9px] uppercase">
                Cílios PRO
              </span>
            </div>
            <p className="mt-2 font-display text-[1.6rem] leading-none text-espresso">
              Excelência
            </p>
      ...
      >
        <span className="tracking-luxe text-[9px] uppercase text-espresso/50">
          Role para descobrir
        </span>
