...
import { FAQ, waLink } from "../../data/site";
        ...
        <div className="lg:col-span-5">
          ...
          <Reveal delay={0.18}>
            <p className="mt-6 max-w-sm text-espresso/60">
              Ainda com uma pergunta? Fale diretamente com a Josiane pelo
              WhatsApp — será um prazer te atender.
            </p>
          </Reveal>
          <Reveal delay={0.24}>
            <a
              href={waLink("Olá! Tenho uma dúvida antes de agendar.")}
              target="_blank"
              rel="noreferrer"
