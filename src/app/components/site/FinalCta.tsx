  ...
  return (
    <section id="contato" className="relative px-4 py-16 md:px-10 md:py-24">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-espresso md:rounded-[2.5rem]">
        ...
        <div
          aria-hidden
          className="glow-rose pointer-events-none absolute -right-20 top-0 size-80 rounded-full opacity-50 blur-3xl"
        />
        ...
        <div className="relative px-6 py-20 text-center md:px-10 md:py-28">
          ...
          >
            Reserve o seu horário e viva uma experiência de beleza pensada em
            cada detalhe — do acolhimento ao resultado final.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <BookButton
              variant="light"
              message="Olá! Quero transformar meu olhar. Vamos agendar?"
            >
              Agendar atendimento
            </BookButton>
          </motion.div>
