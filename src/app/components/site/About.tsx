    ...
    >
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-14 px-5 md:px-10 lg:grid-cols-2 lg:gap-20">
        ...
        <div className="relative order-1">
          ...
          >
            <p className="font-display text-[2.2rem] leading-none text-gradient-gold">
              +1000
            </p>
            <p className="mt-1 tracking-luxe text-[9px] uppercase text-espresso/60">
        ...
        <div className="order-2">
          ...
          <Reveal delay={0.18}>
            <p className="mt-6 max-w-lg text-lg leading-relaxed text-espresso/70">
              Há um ano transformando autoestimas, Josiane uniu técnica,
              sensibilidade e um olhar refinado para criar resultados que
              valorizam a beleza única de cada cliente.
            </p>
          </Reveal>
          <Reveal delay={0.24}>
            <p className="mt-4 max-w-lg leading-relaxed text-espresso/60">
              Especialista PRO em extensão de cílios, ela acredita que cada
              detalhe importa — do acolhimento à finalização. O cuidado começa
              muito antes do primeiro fio.
            </p>
          </Reveal>
            ...
            {STATS.map((s, i) => (
              <Reveal key={s.label} delay={0.1 + i * 0.08}>
                <div className="h-full bg-card p-5 text-center">
                  <p className="font-display text-[1.7rem] leading-none text-espresso">
                    {s.value}
                  </p>
          ...
          <Reveal delay={0.2}>
            <div className="mt-10">
              <BookButton variant="outline" message="Olá! Conheci o estúdio pelo site e quero agendar.">
