...
/* Animated eyebrow label with hairlines */
export function SectionLabel({
  ...
  return (
    ...
    >
      <span
        className={`h-px w-8 ${light ? "bg-white/40" : "bg-gold/50"}`}
        aria-hidden
      />
      <span
        className={`tracking-luxe uppercase text-[11px] ${
...
/* Primary booking button (espresso, magnetic shine) */
