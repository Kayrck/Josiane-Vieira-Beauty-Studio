...
export function BeforeAfter() {
  ...
  return (
    <section id="resultados" className="relative overflow-hidden bg-secondary/60 py-24 md:py-32">
      <Orb className="left-[-10%] top-10 size-[28rem]" />
      <div className="mx-auto max-w-6xl px-5 md:px-10">
        <div className="mx-auto max-w-2xl text-center">
          <Reveal><SectionLabel center>Antes & Depois</SectionLabel></Reveal>
          <Reveal delay={0.1}>
        ...
        <Reveal delay={0.16}>
          ...
          >
            ...
            {/* Handle do slider */}
            <div className="absolute inset-y-0 z-10 w-0.5 bg-white shadow-[0_0_20px_rgba(0,0,0,0.25)]" style={{ left: `${pos}%` }}>
        ...
        <Reveal delay={0.2}>
          <div className="mt-12 flex flex-col items-center gap-4 text-center">
            <p className="max-w-md text-espresso/60">
              Resultados naturais, marcantes e feitos sob medida para realçar a sua expressão.
            </p>
            <BookButton message="agendar-agora">Quero meu resultado</BookButton>
          </div>
        </Reveal>
      </div>
    </section>
